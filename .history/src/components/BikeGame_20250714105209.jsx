...
import React, { useState, useEffect, useRef } from "react";
// import * as XLSX from "xlsx"; // Remove this import
// import { saveAs } from "file-saver"; // Remove this import
    ...
    const interval = setInterval(() => {
      setObstacleX((prev) => {
        if (prev < -100) {
          ...
          setObstacleType(isBird ? "bird" : "cactus");
          setObstacleImage(
            isBird ? birdFrames[0] : cactusImages[Math.floor(Math.random() * cactusImages.length)]
          );
          return window.innerWidth + 50; // Use viewport width for better mobile compatibility
        }
        // Adjust speed based on screen size
