...
export default function BikeGame() {
  ...
  useEffect(() => {
    ...
    const trackInterval = setInterval(() => {
      setTrackPosition((prev) => (prev - speed) % window.innerWidth);
    }, 30);
    return () => clearInterval(trackInterval);
  }, [gameOver, speed]);

  // Move obstacles and increase speed
  useEffect(() => {
    if (gameOver) return;
  ...
  return (
    ...
    .track {
      ...
      z-index: 1;
      object-fit: cover;
      background-image: url(${trackImg});
      background-repeat: repeat-x;
      background-position-x: ${trackPosition}px;
    }
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <div className="game-container">
          ...
          <div
            className="track"
            style={{
              backgroundPositionX: `${trackPosition}px`,
            }}
          />
          <div
            className="bike"
